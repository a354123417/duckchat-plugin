...
class ApiSessionLoginRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>string siteIdPubkPem = 3;</code>
     */
    private $siteIdPubkPem = '';
     ...
     * @return string
     */
    public function getSiteIdPubkPem()
    {
        return $this->siteIdPubkPem;
    }
     ...
     * @return $this
     */
    public function setSiteIdPubkPem($var)
    {
        GPBUtil::checkString($var, True);
        $this->siteIdPubkPem = $var;
